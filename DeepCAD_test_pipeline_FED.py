...
if download_demo_file:
    ...
    #datasets_path = 'datasets/testing'  # folder containing tif files for testing
    datasets_path = 'datasets/testing'  # folder containing tif files for testing
    denoise_model = 'training_202312211447'  # A folder containing pth models to be tested
...
test_dict = {
    ...
    'save_test_images_per_epoch': save_test_images_per_epoch   # image after each epoch in pth path
}
#print(test_dict)
